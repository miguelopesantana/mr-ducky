...
_inbound_default = NegotiationContext(
    ...
    tenure_years=4,
    friend_price_eur=5.00,
    target_price_eur=5.00,
    walk_away_threshold_eur=7.00,
...
class StartSessionRequest(BaseModel):
    ...
    tenure_years: int = 4
    friend_price_eur: float = 5.00
    target_price_eur: float = 5.00
    walk_away_threshold_eur: float = 7.00
