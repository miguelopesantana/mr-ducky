...
export const T = {
  ...
  overlayCard: 'var(--color-overlay-card)',
  popoverSurface: 'var(--color-popover-surface)',
  popoverBorder: 'var(--color-popover-border)',
  inkOnBrand: 'var(--color-ink-on-brand)',
  inkOnBrandMuted: 'var(--color-ink-on-brand-muted)',
  inkSoft: 'var(--color-ink-soft)',
  successBg: 'var(--color-success-bg)',
  warningBg: 'var(--color-warning-bg)',
  dangerBg: 'var(--color-danger-bg)',
  switchOff: 'var(--color-switch-off)',
